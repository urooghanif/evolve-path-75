...
const DEMO_USERS: Record<Role, DemoUser> = {
  hr_admin: { id: "U-HR-01", name: "Aisha Khan", email: "aisha.khan@company.com.pk", role: "hr_admin", department: "Human Resources", rank: 18, designation: "HR Business Partner", avatarColor: "#0052ff" },
  ...
  c_level: { id: "U-CXO-01", name: "Tariq Mahmood", email: "tariq.mahmood@company.com.pk", role: "c_level", department: "Executive", rank: 20, designation: "Chief Executive Officer", avatarColor: "#0a0b0d" },
